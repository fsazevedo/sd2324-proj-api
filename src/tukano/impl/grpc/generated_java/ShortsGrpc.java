...
public final class ShortsGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserArgs,
      tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserResult> getBurnDownUserMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "burnDownUser",
      requestType = tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserArgs.class,
      responseType = tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserResult.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserArgs,
      tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserResult> getBurnDownUserMethod() {
    io.grpc.MethodDescriptor<tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserArgs, tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserResult> getBurnDownUserMethod;
    if ((getBurnDownUserMethod = ShortsGrpc.getBurnDownUserMethod) == null) {
      synchronized (ShortsGrpc.class) {
        if ((getBurnDownUserMethod = ShortsGrpc.getBurnDownUserMethod) == null) {
          ShortsGrpc.getBurnDownUserMethod = getBurnDownUserMethod =
              io.grpc.MethodDescriptor.<tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserArgs, tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserResult>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "burnDownUser"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserArgs.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserResult.getDefaultInstance()))
              .setSchemaDescriptor(new ShortsMethodDescriptorSupplier("burnDownUser"))
              .build();
        }
      }
    }
    return getBurnDownUserMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void burnDownUser(tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserArgs request,
        io.grpc.stub.StreamObserver<tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserResult> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getBurnDownUserMethod(), responseObserver);
    }
  }
  ...
  public static final class ShortsStub
    ...
    /**
     */
    public void burnDownUser(tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserArgs request,
        io.grpc.stub.StreamObserver<tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserResult> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getBurnDownUserMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class ShortsBlockingStub
    ...
    /**
     */
    public tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserResult burnDownUser(tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserArgs request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getBurnDownUserMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class ShortsFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserResult> burnDownUser(
        tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserArgs request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getBurnDownUserMethod(), getCallOptions()), request);
    }
  }
  ...
  private static final int METHODID_BURN_DOWN_USER = 9;
      ...
      switch (methodId) {
        ...
        case METHODID_GET_FEED:
          serviceImpl.getFeed((tukano.impl.grpc.generated_java.ShortsProtoBuf.GetFeedArgs) request,
              (io.grpc.stub.StreamObserver<tukano.impl.grpc.generated_java.ShortsProtoBuf.GetFeedResult>) responseObserver);
          break;
        case METHODID_BURN_DOWN_USER:
          serviceImpl.burnDownUser((tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserArgs) request,
              (io.grpc.stub.StreamObserver<tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserResult>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          getBurnDownUserMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserArgs,
              tukano.impl.grpc.generated_java.ShortsProtoBuf.BurnDownUserResult>(
                service, METHODID_BURN_DOWN_USER)))
        .build();
  }
      ...
      synchronized (ShortsGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getBurnDownUserMethod())
              .build();
        }
      }
    }
